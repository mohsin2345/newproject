...
$run_order = mysqli_query($con,$insert_order);
    ...
    <html>
    <p>
    Hello Dear <b style='color:blue;'>$customer_name</b> you have ordered some products on website mysite.com,please find your order details below and pay the duesas soon as possible,so we can proceed your order. Thank you!</p>
