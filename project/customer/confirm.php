...
<tr>
    ...
    <td>
        <select name="payment_method">
            ...
            <option>EasyPaise/HBL Omni</option>
...
<tr>
    <td align="right">EasyPaise/UBLOMNI code:</td>
...
if(isset($_POST['confirm'])){
    ...
    if($run_payment){
        echo "<h2 style='text-align:center; color:white;'>Payment received, your order will be completed within 24 horus</h2>";
    }
